---
title: Maxkore的极客空间 · 使用指南
description: 从零开始掌握你的个人极客空间
date: 2026-03-01
author: Maxkore
tags: [指南, 教程, 入门]
...
恭喜你的个人极客空间成功上线！这篇文章将带你全面了解如何使用和维护你的网站。
...
1. 是否执行了 `git push`
2. 查看GitHub Actions状态：`https://github.com/Maxkore-Geek/docs-site/actions`
3. 等待2-3分钟缓存刷新
...
注册 [Algolia DocSearch](https://docsearch.algolia.com/)，然后在 `docusaurus.config.ts` 中配置。
